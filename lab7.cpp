...
//
bankAccount **readfile(string file,int size);
////....printAccounts(....);
...

{
	...
	//
	//
	bankAccount *b1 = new bankAccount(10,1300,15000);
	...
	bankAccount *b2[2];
	b2[0] = new bankAccount(30,2000,15000);
	b2[0]->deposit(3000);
	b2[0]->deposit(5000);
	b2[0]->deposit(60000);
	...
	b3[0] = new bankAccount(50,2000,15000);
	b3[0]->withdraw(5000);
	b3[1]->deposit(5000);
...
bankAccount **readfile(string file,int size){
	...
	while(!fin.eof())
	{
		...
		fin>>limit;
		fin>>transaction_no;
		transactions = new int[transaction_no];
		for(int i=0;i<transaction_no;i++)
			fin>>transactions[i];

		cout<<"no of accounts : "<<accno<<endl;
		cout<<"ID : "<<id<<endl;
		cout<<"balance : "<<balance<<endl;
		cout<<"Limit : "<<limit<<endl;
		cout<<"no of transactions : "<<transaction_no<<endl;
	...
	void printaccount(bankAccount **b4,int size,int amount,int id)
